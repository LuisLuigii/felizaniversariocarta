...
window.onload = () => {
  ...
  const romanticLetter = isMobile ? [
    ...
    "Y es que ya es un año juntos|",
    "donde ha habido de todo,|",
    "momentos increibles los cuales|",
    "siempre llevare en mi memoria,|",
    "momentos en donde me da mucho|",
    "miedo perderte y solo quiero|",
    "que me abraces con tus fuerzas.||",
